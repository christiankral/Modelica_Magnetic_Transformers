...
model Yz09 "Transformer Yz9"
  extends Modelica_Magnetic_Transformers.Interfaces.ThreePhase.Transformer(final VectorGroup="Yz09");
...
connect(transformer.plug_p1, plug1) annotation (Line(
    ...
    color={0,0,255},
    smooth=Smooth.None));
connect(star1.plug_p, transformer.plug_n1) annotation (Line(
    points={{-10,-70},{-10,-6}},
    color={0,0,255},
    smooth=Smooth.None));
connect(transformer.plug_p2, Rot21.plug_n) annotation (Line(
    points={{10,10},{50,10}},
    color={0,0,255},
    smooth=Smooth.None));
connect(transformer.plug_p3, Rot21.plug_p) annotation (Line(
    points={{10,-4},{30,-4},{30,-10},{50,-10}},
    color={0,0,255},
    smooth=Smooth.None));
connect(transformer.plug_n2, Rot22.plug_p) annotation (Line(
