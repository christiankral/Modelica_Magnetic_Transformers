...
BaseTransformers.ThreePhase.Dd.Dd00 transformer2(
  ...
  T2Operational=293.15)
                 annotation (Placement(transformation(extent={{-50,-50},{-30,
          -30}}, rotation=0)));

  parameter Modelica.Electrical.Machines.Utilities.TransformerData transformerData2(
    ...
    P_sc=300) annotation (Placement(transformation(extent={{-60,-80},{-40,-60}},
          rotation=0)));
initial equation
  transformer2.transformer.i1 = zeros(3);
